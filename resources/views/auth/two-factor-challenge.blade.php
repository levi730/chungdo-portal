...
<form method="POST" action="{{ url('/two-factor-challenge') }}" class="card card-md">
    ...
    <div class="card-body">
        ...
        <div id="code" class="form-group mb-3 ">
            ...
            <div>
                <input type="text" name="code" autofocus autocomplete="none" class="form-control">
        ...
        <div id="emergency" class="form-group mb-3 d-none">
            ...
            <div>
                <input type="text" name="recovery_code" autofocus autocomplete="none" class="form-control">
