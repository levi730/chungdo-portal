    ...
    <div class="page-wrapper">
        ...
        <footer class="footer footer-transparent d-print-none">
            <div class="container-xl">
                ...
                <div class="row text-center align-items-center flex-row-reverse mt-2">
                    <div class="col-12 col-lg-auto mt-5 mt-lg-0">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 80 97.7" style="enable-background:new 0 0 80 97.7; width:15px;" xml:space="preserve">
                                ...
                                <a target="_blank" href="https://linktr.ee/chungdotkd">https://linktr.ee/chungdotkd</a>
                            </li>
                        </ul>
                    </div>
                </div>
